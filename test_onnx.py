...
def infer_yolop(weight="yolop-640-640.onnx",
    ...
    onnx_path = f"./weights_old/{weight}"
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--img', type=str, default="inference/images/-nfs-公交车辆检测标注-公交车辆检测车尾晴-20210916-公交车辆检测车尾晴-20210916-2b249a136421361d34b7b9034d44aa12.jpg")
