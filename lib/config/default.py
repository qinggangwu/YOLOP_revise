...
_C.MODEL.HEADS_NAME = ['']
# _C.MODEL.PRETRAINED = "/home/wqg/pyproject/git/YOLOP/weights/End-to-end.pth"
_C.MODEL.PRETRAINED = ""
...
_C.DATASET.DATAROOT = '/home/wqg/data/公司数据/car_line/images/'       # the path of images folder
_C.DATASET.LABELROOT = '/home/wqg/data/公司数据/car_line/det_annotations/'           # the path of det_annotations folder
# _C.DATASET.MASKROOT = '/home/wqg/data/公司数据/car_line/ll_seg_annotations/'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/wqg/data/公司数据/car_line/ll_seg_annotations/'               # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'BddDataset'
_C.DATASET.TRAIN_SET = 'train'
_C.DATASET.TEST_SET = 'val'
_C.DATASET.DATA_FORMAT = 'jpg'
_C.DATASET.SELECT_DATA = False
# _C.DATASET.ORG_IMG_SIZE = [567, 1024]
